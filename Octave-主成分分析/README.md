...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;{error}_r=\frac{1}{n}i=1nxi-xi=1ni=1nxi-xiTXI-XI" title="〖error〗_r=1/n ∑_(i=1)^n▒‖x_i-(x_i ) ̃ ‖ =1/n ∑_(i=1)^n▒(x_i-(x_i ) ̃ )^T  (X_I-(X_I ) ̃ )   " />
